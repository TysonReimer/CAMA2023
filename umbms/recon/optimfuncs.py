...
def get_ref_derivs(phase_fac, fd, fwd, freqs,
                   beam=None, gain=None, spherical=None,
                   n_cores=2):
...
def _parallel_ref_deriv(phase_fac, fwd, fd, freqs, beam, gain, spherical, ff):
    ...
    s_deriv = phase_fac**(2 * freqs[ff]) * gain[ff] * beam * spherical
